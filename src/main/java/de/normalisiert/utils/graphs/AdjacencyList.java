...
public class AdjacencyList {
   ...
   *          array with the adjacency-matrix that represents the graph
   ...
   *         adjacency, the second dimension represents the indicies of those
   *         nodes, that are direct successornodes of the node.
   */
